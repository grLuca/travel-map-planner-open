...
export const provinceCityOptions: ProvinceCityOption[] = [
  ...
  { province: '海南', cities: ['海口', '三亚', '三沙', '儋州', '琼海', '文昌', '万宁', '东方', '五指山'] },
  {
    province: '四川',
  ...
  {
    province: '新疆',
    cities: ['乌鲁木齐', '克拉玛依', '吐鲁番', '哈密', '昌吉', '博尔塔拉', '巴音郭楞', '阿克苏', '克孜勒苏', '喀什', '和田', '伊犁', '塔城', '阿勒泰', '石河子', '阿拉尔', '图木舒克', '五家渠', '北屯', '铁门关', '双河', '可克达拉', '昆玉', '胡杨河', '新星'],
  },
  { province: '香港', cities: ['香港'] },
  { province: '澳门', cities: ['澳门'] },
  {
    province: '台湾',
    cities: ['台北', '新北', '桃园', '台中', '台南', '高雄', '基隆', '新竹', '嘉义', '宜兰', '花莲', '台东', '澎湖', '金门', '连江'],
  },
];
